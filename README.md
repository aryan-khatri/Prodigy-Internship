...
Recently, I joined an internship at Prodigy, where I worked on four tasks focusing on full-stack web development. During this time, I gained hands-on experience in both front-end and back-end technologies, enhancing my skills in building dynamic and responsive web applications. Welcome to my Prodigy Internship repository, showcasing the skills and projects completed during my internship as a Full Stack Web Developer. Below, you'll find details about the tasks completed, the technologies utilized, and how to set up and run each project locally. 
...
Implemented a real time chat application for user where you can chat and so many more 
...
| Task 4      | Real Time Chat Application                | [Live Website](https://prodigy-internship-iii.vercel.app)|
